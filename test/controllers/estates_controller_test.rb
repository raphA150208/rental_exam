...
class EstatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estate" do
    assert_difference('Estate.count') do
      post estates_url, params: { estate: { adress: @estate.adress, age: @estate.age, content: @estate.content, name: @estate.name, price: @estate.price } }
    end
  ...
  test "should update estate" do
    patch estate_url(@estate), params: { estate: { adress: @estate.adress, age: @estate.age, content: @estate.content, name: @estate.name, price: @estate.price } }
